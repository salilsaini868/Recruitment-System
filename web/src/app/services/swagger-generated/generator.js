...
var Generator = (function () {
    ...
    Generator.prototype.initialize = function () {
        ...
        this.templates = {
            'class': fs.readFileSync(__dirname + "/swagger-templates/angular2-service.mustache", 'utf-8'),
            'model': fs.readFileSync(__dirname + "/swagger-templates/angular2-model.mustache", 'utf-8'),
            'models_export': fs.readFileSync(__dirname + "/swagger-templates/angular2-models-export.mustache", 'utf-8')
        };
    ...
    Generator.prototype.createMustacheViewModel = function () {
        ...
        var data = {
            ...
            swagger: swagger,
            serviceName:this._outputServiceFileName !==undefined ? this._outputServiceFileName :'ApiClientService',
            ...
            _.forEach(api, function (op, m) {
                ...
                _.forEach(params, function (parameter) {
                    ...
                    if (parameter.type === 'integer' || parameter.type === 'double') {
                        ...
                        parameter.isNumberParameter = true;
                    } else if (parameter.type === 'array') {
                        parameter.type = 'any[]';
                        parameter.typescriptType = 'any[]';
                        parameter.isArrayParameter = true;
                    } else
        ...
        _.forEach(swagger.definitions, function (defin, defVal) {
            ...
            _.forEach(defin.properties, function (propin, propVal) {
                ...
                if (property.isRef) {
                    ...
                    let ifExists = definition.refsImports.find(x => x.type === property.type);
                    if (ifExists === undefined) {
                        definition.refsImports.push(property);
                    }
                } else {
